...
function Content({ showMenu, setShowMenu }) {
    ...
    return (
        <>
            <div
                style={{ zIndex: 1000 }}
                className="absolute md:top-8 bottom-0 flex flex-col gap-4 w-full p-8 md:pd-0 md:w-[400px] rounded-t-3xl md:gap-0 md:rounded-full bg-bgWhite md:bg-transparent"
            >
